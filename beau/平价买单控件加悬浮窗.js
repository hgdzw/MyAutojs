        ...
        <appbar>
            ...
            <vertical gravity="center" layout_weight="1">
                ...
                <vertical padding="10 6 0 6" bg="#ffffff" w="*" h="auto" margin="0 5" elevation="1dp">
                    ...
                    <View h="5"/>
                    <Switch id="floatingWindow" w="*" checked="false" textColor="#666666" text="悬浮窗"/>           
                ...
                <vertical margin="0 10" bg="#ffffff" elevation="1dp" padding="5 5 10 5" w="*" h="auto">          
                    ...
                    <linear>
                        <checkbox id="fiveQu" text="5000区" checked="true" layout_weight="1"/>  
                        <text text="是否抢五千"/>           
                    </linear>
                    <linear>
                        <checkbox id="twoWan" text="20000区" checked="true" layout_weight="1"/>  
                        <text text="是否抢两万"/>           
                    </linear>
                    <linear>
                        <checkbox id="fiveWan" text="50000区" checked="true" layout_weight="1"/>  
                        <text text="是否抢五万"/>           
                    </linear>
                </vertical>     
                ...
                <vertical margin="0 10" bg="#ffffff"  elevation="1dp" h="*" id="tips">
                    ...
                    <text gravity="center" text="5. 添加悬浮窗功能，开启和关闭在悬浮窗里面来进行。" line="3"/>           
                </vertical> 
...
// 悬浮窗开关监控
ui.floatingWindow.setOnCheckedChangeListener(function(widget,checked) {
    if(checked) {     
